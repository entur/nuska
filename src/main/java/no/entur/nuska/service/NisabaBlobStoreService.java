...
public class NisabaBlobStoreService {
  ...
  public static final int MAX_NUM_IMPORT = 100;
  ...
  public ByteArrayResource getBlob(String codespace, String importKey) {
    InputStream blob = repository.getBlob(
      IMPORTED_SUB_PATH + codespace + '/' + importKey + ZIP_EXTENSION
    );
    if (blob == null) {
      return null;
    }
